...
class QuestionOptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create question_option" do
    assert_difference("QuestionOption.count") do
      post question_options_url, params: { question_option: { deleted_at: @question_option.deleted_at, is_correct: @question_option.is_correct, question_id: @question_option.question_id, title: @question_option.title } }
    end
  ...
  test "should update question_option" do
    patch question_option_url(@question_option), params: { question_option: { deleted_at: @question_option.deleted_at, is_correct: @question_option.is_correct, question_id: @question_option.question_id, title: @question_option.title } }
